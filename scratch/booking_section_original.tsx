  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok && data.success) {
        ...
        setErrorMsg(data.error || (language === "es" ? "Ocurri├│ un error al agendar la cita. Int├®ntalo de nuevo." : "Error booking slot."))
      }
    } catch (err: any) {
      setIsSubmitting(false)
      setErrorMsg(
        err?.message ||
        (language === "es"
          ? "No se pudo completar el agendamiento. Por favor verifica tu conexi├│n o int├®ntalo nuevamente."
  ...
  return (
    <section id="agendar" className="relative z-30 py-12 sm:py-16 pb-24 sm:pb-32 bg-[#F5F4F0]">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        {/* ÔöÇÔöÇ SECTION HEADER ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */}
        ...
        {/* ÔöÇÔöÇ PROGRESS INDICATOR (STEP 1 OF 3) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */}
        {step < 4 && (
        ...
        {/* ÔöÇÔöÇ CONTAINER BENTO BOARD ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */}
        <div className="bg-white rounded-2xl border border-black/[0.08] p-6 sm:p-8 md:p-10 shadow-xs">
          
          {/* ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ STEP 1: SELECT ADVISORY TOPIC ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */}
          {step === 1 && (
            <div className="space-y-6">
              <div className="space-y-1">
                <h3 className="text-xl font-medium text-[#111]">
                  {language === "es" ? "┬┐En qu├® ├írea deseas enfocar tu asesor├¡a?" : "What area do you want to focus your session on?"}
                </h3>
                <p className="text-xs sm:text-sm text-black/75 font-normal">
                  {language === "es" ? "Selecciona la opci├│n principal para asignar al especialista de nuestra unidad." : "Select the main topic to assign our Growth Unit specialist."}
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <button
                  type="button"
                  aria-label="Abrir selecci├│n de ├írea de asesor├¡a"
                ...
                >
                  <div className="flex items-center gap-4 min-w-0 pr-2">
                    ...
                    <div className="min-w-0">
                      <div className="text-[10px] font-mono text-black/40 uppercase tracking-widest font-semibold">├üREA SELECCIONADA</div>
          ...
          {/* ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ STEP 2: CALENDAR & HORARIOS ÔöÇÔöÇÔöÇÔöÇÔöÇ */}
          {step === 2 && (
            <div className="space-y-6">
                ...
                <div className="lg:col-span-5 space-y-4">
                  ...
                  {selectedDay && (
                    <div className="p-3.5 rounded-xl bg-black/[0.03] border border-black/[0.06] text-xs space-y-1">
                      <span className="text-[10px] font-mono text-black/70 uppercase tracking-widest block font-medium">CITACI├ôN SELECCIONADA</span>
                      <p className="font-medium text-[#111]">{formattedDate} ÔÇö {selectedSlot}</p>
                    </div>
                  )}
                </div>
          ...
          {/* ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ STEP 3: CONTACT & COMPANY DETAILS FORM ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */}
          {step === 3 && (
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-black/60 font-normal mt-0.5">
                    {language === "es" ? "Ingresa tu informaci├│n para confirmar la citaci├│n y enviar el correo de acceso." : "Enter your contact details to send email confirmation."}
                  </p>
                </div>
              ...
              <div className="p-3.5 rounded-xl bg-black/[0.02] border border-black/10 flex items-start gap-3">
                ...
                <label htmlFor="habeasDataConsent" className="text-[11px] text-black/75 leading-relaxed font-sans cursor-pointer select-none">
                  {language === "es" ? (
                    <>
                      Autorizo a <strong>Smartcontacts</strong> para el tratamiento de mis datos personales y el env├¡o de confirmaciones y comunicaciones relativas a esta reserva seg├║n la <strong>Ley 1581 de 2012 (Habeas Data)</strong> y la <a href="/privacidad" target="_blank" className="underline hover:text-black">Pol├¡tica de Privacidad</a>.
                    </>
                  ) : (
                    <>
          ...
          {/* ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ STEP 4: SUCCESS EMAIL CONFIRMATION CARD ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */}
          {step === 4 && (
            <div className="space-y-6 text-center py-6">
              ...
              <div className="p-5 rounded-2xl border border-black/[0.08] bg-black/[0.02] text-left space-y-3 max-w-lg mx-auto">
                ...
                <div className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl bg-white border border-black/[0.04]">
                  <span className="text-[10px] text-black/30 font-mono min-w-[70px]">CITACI├ôN</span>
