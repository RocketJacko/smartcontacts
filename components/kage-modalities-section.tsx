  ...
  const modalities = [
    {
      ...
      features: [
        language === "es" ? "Contacto directo sobre datos propios, perfilados por 5 variables" : "Direct contact on proprietary data, segmented by 5 variables",
        language === "es" ? "Presentación de oferta, calificación y manejo de objeciones" : "Offer presentation, qualification, and objection handling",
        language === "es" ? "Ciclo comercial completo hasta agendamiento o cierre" : "Complete commercial cycle up to scheduling or closing",
        language === "es" ? "Despacho automatizado cuando el producto lo permite" : "Automated dispatch when product model allows",
        language === "es" ? "Cero intervención en tus procesos internos" : "Zero intervention in internal processes",
      ],
      impact: language === "es" ? "+340% de velocidad en prospección comercial (impacto probado)" : "+340% Commercial Prospecting Velocity (proven impact)",
